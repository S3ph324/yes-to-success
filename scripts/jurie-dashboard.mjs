...
async function viewGenerate(){
  ...
  $('#view').innerHTML=wfHtml
   ...
   +'<p class="muted" style="margin:0 0 10px;font-size:11px">Upload 3\\u20134 angles of ONE product (front, side, on-face, detail) for a varied carousel \\u2014 one photo means all cards reuse it. <b>Plain white backgrounds look cleanest</b> (the product reads like a cutout on the hero). We brand your real photos, no AI redraw \\u2014 cards are square 1:1 for TikTok Shop.</p>'
